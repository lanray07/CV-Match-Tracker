...
The workflow uses Xcode automatic signing on GitHub's macOS runner. The App Store Connect private key should be the full `.p8` key contents, including the `BEGIN PRIVATE KEY` and `END PRIVATE KEY` lines.
